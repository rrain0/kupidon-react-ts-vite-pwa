...
export namespace _CheckboxInputS6 {
  
  
  export function buildWidgetElems(up?: AttachRootElemParams) {
    const buttonElems = ButtonS6.buildWidgetElems(up)
    
    const input = WidgetElem.of({
      upElem: buttonElems.button, upSelector: '>', className: 'rruiInput',
    })
    const iconBox = WidgetElem.of({
      upElem: buttonElems.button, upSelector: '>', className: 'rruiIconBox',
    })
    const iconBoxChecked = WidgetElem.of({
      upElem: buttonElems.button, upSelector: '>', className: 'rruiIconBoxChecked',
    })
    const iconChecked = WidgetElem.of({
      upElem: iconBoxChecked, upSelector: '>', className: 'rruiIconChecked',
    })
    
    return { ...buttonElems, input, iconBox, iconBoxChecked, iconChecked } as const
  }
  ...
  export namespace Parts {
    export const base: WidgetStyle = [
      ButtonS6.Parts.base, {
        input: [resetInput, absTlwh, {
          opacity: 0,
        }],
        iconBox: [flexC, { pointer: false }],
        iconBoxChecked: { display: 'none', pointer: false },
      },
    ]
