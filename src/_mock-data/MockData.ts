...
import kenganAshuraOp from 'src/res/im/test/[DragsterPS] Kengan Ashura S01E05 [1080p].mkv_20211001_171919.444.jpg'
...
import needMoreAcid from 'src/res/im/test/need_more_acid_mark_ii.jpg'
import nextUp from 'src/res/im/test/NEXT UP.jpg'
import ourLastNight from 'src/res/im/test/Our Last Night.jpg'
import pgrHalloween from 'src/res/im/test/PGR 2.5 Anniversary Halloween Poster Custom Wallpapers.jpg'
import retrowave1 from 'src/res/im/test/Retrowave (1).png'
import retrowave2 from 'src/res/im/test/Retrowave_(2).jpg'
import hotlineMiami2 from 'src/res/im/test/wallpaper-Hotline-Miami-2---Wrong-Number2560x1440.jpg'
