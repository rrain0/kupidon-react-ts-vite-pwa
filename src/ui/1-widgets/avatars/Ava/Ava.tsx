...
const MutualSympathyMarkBox = styled(Flex)`
  position: absolute;
  top: -2%;
  left: -4%;
  width: 36%;
  ...
  background: linear-gradient(
    to bottom, ${p => p.theme.boxAccentCt4.ctGrad[0]}, ${p => p.theme.boxAccentCt4.ctGrad[1]}
  );
`
